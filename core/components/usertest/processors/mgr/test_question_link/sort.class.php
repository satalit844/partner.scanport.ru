...
class UserTestTestQuestionLinkSortProcessor extends modObjectProcessor {
	...
	public function setIndex() {
		$q = $this->modx->newQuery($this->classKey, array('test_id' => $this->test_id));
		$q->select('id');
...
return 'UserTestTestQuestionLinkSortProcessor';