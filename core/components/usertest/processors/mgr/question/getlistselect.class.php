...
class UserTestQuestionSelectGetListProcessor extends modObjectGetListProcessor
{
    ...
    public function prepareRow(xPDOObject $object)
    {
		...
		$array['actions'][] = array(
            ...
            'title' => $this->modx->lexicon('usertest_question_select'),
			'multiple' => $this->modx->lexicon('usertest_questions_select'),
...
return 'UserTestQuestionSelectGetListProcessor';