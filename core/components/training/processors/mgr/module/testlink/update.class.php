...
class TrainingModuleTestLinkUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        $activityId = $linkType === 'practice'
            ? (int)$this->getProperty('practice_id', $this->getProperty('usertest_test_id', $this->object ? $this->object->get('usertest_test_id') : 0))
            : (int)$this->getProperty('usertest_test_id', $this->object ? $this->object->get('usertest_test_id') : 0);
        ...
        if (TrainingModuleTestLinkHelper::findDuplicate($this->modx, $resolvedCourseId, $moduleId, $activityId, $linkType, $id)) {
