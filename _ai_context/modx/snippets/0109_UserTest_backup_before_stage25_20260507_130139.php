...
if($answer_step != "start" and !$skip_save && $hasPostedQuestion){
    ...
    if($Result = $modx->getObject('UserTestResults',$result_id)){
        ...
        $time_last_step = !empty($_SESSION['UserTest'][$id]['time_last_step'])
            ? (int)$_SESSION['UserTest'][$id]['time_last_step']
            : (!empty($_SESSION['UserTest'][$id]['test_time_start']) ? (int)$_SESSION['UserTest'][$id]['test_time_start'] : time());
