<div class="training-player w-100"
    ...
    <div class="player-resume-modal js-player-resume-modal">
        ...
        <div class="player-resume-modal__dialog">
            ...
            <div class="player-resume-modal__title">Возобновить просмотр</div>
            <div class="player-resume-modal__text js-player-resume-text">Продолжить курс с того места, на котором вы остановились?</div>
            <div class="player-resume-modal__actions">
                <button type="button" class="btn btn-player-nav js-player-start-over">Нет</button>
                <button type="button" class="btn btn-player-next js-player-resume-continue">Да</button>
            </div>
        </div>
    </div>
</div>
