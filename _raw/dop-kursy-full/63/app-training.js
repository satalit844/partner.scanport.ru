    ...
    return {
        ...
        filtersLogic: function () {
            ...
            function getButtonFilter($btn) {
                var filter = $btn.attr('data-filter') || $btn.data('filter') || $btn.attr('data-status') || '';
                if (!filter) {
            ...
            function itemMatches($item, filter) {
                ...
                var status = String($item.attr('data-status') || $item.attr('data-filter') || '').toLowerCase();
                ...
                if (filter === 'active') {
                    return $item.hasClass('is-valid') || text.indexOf('действ') !== -1 || (!$item.hasClass('is-done') && !$item.hasClass('is-expired') && text.indexOf('ист') === -1);
                }

                if (filter === 'expired') {
                    return $item.hasClass('is-expired') || $item.hasClass('is-done') || text.indexOf('ист') !== -1;
                }
            ...
            $blocks.each(function () {
                var $scope = $(this);
                var $active = $scope.find('.filters-corses .course-filter__chip.is-active, .certificates-page__filters .is-active, .certificates-page__filters .active, .certificates-filters .is-active, .certificates-filters .active, .certificates-page__filter.is-active, .certificates-page__filter.active').first();
                var $first = $scope.find('.filters-corses .course-filter__chip, .certificates-page__filters button, .certificates-page__filters a, .certificates-filters button, .certificates-filters a, .certificates-page__filter').first();
