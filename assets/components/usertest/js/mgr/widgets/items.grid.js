UserTest.grid.Items = function (config) {
    config = config || {};
    if (!config.id) {
        config.id = 'usertest-grid-items';
    }
    Ext.applyIf(config, {
    ...
    UserTest.grid.Items.superclass.constructor.call(this, config);
...
Ext.extend(UserTest.grid.Items, MODx.grid.Grid, {
    windows: {},
...
Ext.reg('usertest-grid-items', UserTest.grid.Items);
