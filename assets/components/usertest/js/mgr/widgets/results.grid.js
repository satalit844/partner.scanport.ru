UserTest.grid.Results = function (config) {
    config = config || {};
    if (!config.id) {
        config.id = 'usertest-grid-results';
    }
    Ext.applyIf(config, {
    ...
    UserTest.grid.Results.superclass.constructor.call(this, config);
...
Ext.extend(UserTest.grid.Results, MODx.grid.Grid, {
    windows: {},
    ...
    createItem: function (btn, e) {
        var w = MODx.load({
            xtype: 'usertest-item-window-create',
            id: Ext.id(),
            listeners: {
                success: {
                    fn: function () {
        ...
        MODx.Ajax.request({
            ...
            listeners: {
                success: {
                    fn: function (r) {
                        var w = MODx.load({
                            xtype: 'usertest-item-window-update',
                            id: Ext.id(),
                            record: r,
                            listeners: {
                                success: {
...
Ext.reg('usertest-grid-results', UserTest.grid.Results);
